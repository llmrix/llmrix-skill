...
CREATE TABLE IF NOT EXISTS skill_info (
    ...
    git_path    VARCHAR(256)    DEFAULT NULL,             -- 仓库路径
    status      VARCHAR(16)     NOT NULL DEFAULT 'inactive', -- 技能状态: active, inactive 等
...
CREATE TABLE IF NOT EXISTS skill_version (
    ...
    message     TEXT            DEFAULT NULL,             -- 版本变更说明
    deleted     SMALLINT        NOT NULL DEFAULT 0,       -- 软删除：0=正常 1=已删除
    created_at  TIMESTAMP       NOT NULL DEFAULT CURRENT_TIMESTAMP, -- 创建时间
    updated_at  TIMESTAMP       NOT NULL DEFAULT CURRENT_TIMESTAMP, -- 最后更新时间
...
CREATE OR REPLACE TRIGGER trg_skill_version_updated_at BEFORE UPDATE ON skill_version FOR EACH ROW EXECUTE FUNCTION set_updated_at();
